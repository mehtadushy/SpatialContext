% Uses a histogram of "phrase" features, which are histograms of *sparse*
...
% BoW of SIFT Features (slighty denser) is appended to this new "phrase" feature 
...
clear params;
dictionarySize = [1000, 1500]; %[%20, 40, 50, 100, 
                 %200, 400, 800, 1000];
sigmaFactors = [40;
		80];
for sf = 1:length(sigmaFactors)
...
%Pick 1000 images to do k_means on
dictionarySize = [1000, 1500];%[50 , 100, 200, 400, 800]; %[10, 20 ,40]; % Context Dictionary Size
...
contextDictionarySize = [1000, 1500];%[50 , 100, 200, 400, 800];
