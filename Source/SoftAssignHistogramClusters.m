function [ H_all ] = SoftAssignHistogramClusters( imageFileList, dataBaseDir, featureSuffix, params, canSkip, pfig )
%
...
fprintf('Building SoftAssign Histograms of Histograms using Intersection Distance\n\n');
...
for f = 1:length(imageFileList)
    ...
    sp_progress_bar(pfig,3,4,f,length(imageFileList),'Building Soft Assign Histograms of Histograms:');
