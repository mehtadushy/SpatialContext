function [] = CompileNeighborhoodPoolFeature2DSoftAssignHistogramV2( imageFileList, dataBaseDir, keypoint_textonSuffix,neighborhood_textonSuffix, histogram_size, params, canSkip, pfig )
% Compile 2D histogram of keypoint-sift labels vs neighbourhood pool histogram
% labels with normalization per neighbourhood cluster prior to overall normalization
%   
% 
