...
image_dir = '~/DirectionalPooling/directionalpooling/Data/SceneCategoriesDataset_RotImages2';
...
load(fullfile(data_dir2, 'rot2_scenes_names.mat'));
...
%
%%%
load(fullfile(data_dir2, 'rot2_category_names.mat'));
...
train_test_datafilename = fullfile(data_dir, 'rot2_train_test_data.mat');
