function [] = CompileNeighborhoodPoolFeature2DHistogram( imageFileList, dataBaseDir, keypoint_textonSuffix,neighborhood_textonSuffix, histogram_size, params, canSkip, pfig )
...
fprintf('Building 2D Histograms\n\n');
...
for f = 1:length(imageFileList)
    ...
    H = hist3([kp_data.texton_ind.data neigh.texton_ind.data], histogram_size)/ length(neigh.texton_ind.data);
    H_all = [H_all; H(:)'];
