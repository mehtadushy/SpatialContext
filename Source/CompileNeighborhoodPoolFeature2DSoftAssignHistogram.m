function [] = CompileNeighborhoodPoolFeature2DSoftAssignHistogram( imageFileList, dataBaseDir, keypoint_textonSuffix,neighborhood_textonSuffix, histogram_size, params, canSkip, pfig )
