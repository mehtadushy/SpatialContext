function [] = ComputeSectorwiseDirectionalRelativeKeypointContext(imageFileList, dataBaseDir, params, canSkip)
    %This function computes a relative orientation
    %histogram of Keypoint (SIFT) descriptors within the neighbourhood
    %defined by a radius of sigmaFactor * log(keypoint_sigma)
    %The relative orientation histogram bins kepypoints in each sector in the
