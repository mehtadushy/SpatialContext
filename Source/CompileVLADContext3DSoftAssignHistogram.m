function [] = CompileVLADContext3DSoftAssignHistogram( imageFileList, dataBaseDir, keypoint_textonSuffix,neighborhood_textonSuffix, histogram_size, params, canSkip, pfig )
...
outFName = fullfile(dataBaseDir, sprintf('3Dhistograms_%s_with%s.mat', keypoint_textonSuffix, neighborhood_textonSuffix));
