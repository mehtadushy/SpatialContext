%% Keypoint SIFT BoW With Larger SIFT Support
...
data_dir = '/scratch/common/pool0/dmetha/SceneCategoriesDataset_Data/LargeKeypointSIFT';
...
outfname = fullfile( data_dir, 'results', sprintf('keypointSift_mag%d_bow_accuracy.mat', params.SIFTMagnif));
